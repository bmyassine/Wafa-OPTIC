                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-edit"></i> Produit <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="ajoutp1.php">ajout produit</a></li>
                  ...
                  <li><a><i class="fa fa-edit"></i> categorie <span class="fa fa-chevron-down"></span></a>
                       <ul class="nav child_menu">
                      <li><a href="ajouts1.html">ajout categorie</a></li>
                      <li><a href="mcategorie1.php">modifier categorie</a></li>
                      <li><a href="scategorie1.php">supprimer categorie</a></li>
                      <li><a href="afichcategorie1.php">afficher categorie</a></li>
                      <li><a href="tri1.php">trier categorie</a></li>
                    </ul>
                  </li>
...
$e=new produit(69,"aa","aa",255,"aa",22,888);
$e1=new produit(69,"aa","aa",255,"aa",22,888);
$resultat=$e->afficherid($conn);
$e1->afficherid($conn);
$e2=new categorie(69,255,"aa",22);
$e4=new categorie(252,55,"zz",14);
$resultat1=$e4->recupererid($conn);
$e2->recupererid($conn);
?>
   <fieldset >
      <form name="f1"  method="POST" action="mprod.php" onSubmit="return verif()" >
 <center><legend><h2> Modifier Produit </h2></legend></center>
         <table id="example1" class="table table-striped">
          <tr>
            <th> Code Produit </th>
            <th><select name="codeProd">
          <?php
        foreach ($resultat as $res) {
  ?>
<option value=<?php echo $res['codeProd']; ?>><?php echo $res['codeProd']; ?>           <?php
}?>
          </tr>
          <tr>
            <th> Image </th>
