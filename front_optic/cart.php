            ...
            <div class="container">
               ...
               <td class="pro-title"><a href="#"><?php echo $row['nom'];?></a></td>
                <td class="pro-price"><span><?php echo $row['prix'];?></span></td>
                    <td class="pro-price" ><span id="q<?php echo $row['codeProd'] ; ?>"><?php echo $row['quantite'] ;?></span></td>
                   <td class="pro-price" ><span id="tps<?php echo $row['codeProd'] ; ?>"><?php echo ($row['prix'] * $row['quantite']) ;?></span></td>
                   <td class="pro-remove"><a href="views/test.php?codeProd=<?php echo $row['codeProd'] ; ?>" class="supp_panier"><i class="fa fa-trash-o"></i></a></td>
                   <td class="pro-remove"><a href="views/panier.php?codeProd=<?php echo $row['codeProd'] ; ?>" class="plus_panier"><i class="fa fa-cart-plus"></i></a></td>
