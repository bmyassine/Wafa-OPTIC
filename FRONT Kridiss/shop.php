                        ...
                        <div class="shop_sidebar">
                            ...
                            <div class="sidebar_widget search mb--60">
                                ...
                                <div class="sidebar_search">
                                    <form name="Form2" method="POST" onsubmit="shop.php">
                                        <input type="text" placeholder="Search for:" name="recherch">
                                        <button type="submit" name="chercher" value="chercher"><i class="ti-search"></i></button>
                                    </form>
                                </div>
                            </div>
                            <!-- End Single Wedget -->
...
$id=$res['codeProd']
  ?>
                        ...
                        <div class="product">
                            <div class="thumb">
                                ...
                                <div class="product_action">
                                    ...
                                    <lu>
                                    <h6>
                                        <a href="single-product.html">likes (15)</a>
                                    </h6>	
                                    </lu>
                                    ...
                                    <ul class="cart_action">
                                        ...
                                        <li>
                                            <a href="php/action.php?t=like&id=<?php echo $id; ?>">
 ...
 else
    {
      ...
      $Yacine=$e->recherchern($_POST['recherch'],$conn);
      ...
      ?>
                <div class="col-lg-3 col-xl-3 col-sm-6 col-12">
                        <div class="product">
                            <div class="thumb">
                                <a href="single-product.html">
                                    <img src="<?php echo $res['image'];?>" alt="product img">
                                </a>
                                <div class="product_action">
                                    <h4>
                                        <a href="single-product.html"><?php echo $res['nom']; ?></a>
